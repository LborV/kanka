...
class Organisation extends Layout
{
    ...
    public function columns(): array
    {
        $columns = [
            ...
            'pinned' => [
                'label' => '<i class="fa-solid-map-pin" data-title="' . __('organisations.members.fields.pinned') . '" data-toggle="tooltip"></i><span class="sr-only">' . __('organisations.members.fields.pinned') . '</span>',
                'render' => function ($model) {
                    if (! $model->pinned()) {
                        return '';
                    }

...
{!! $datagrid
    ->columns([
        ...
        [
            ...
            'render' => function (\App\Models\Relation $model) {
                return $model->isMirrored() ? '<i class="fa-solid-link" aria-hidden="true" data-toggle="tooltip" data-title="' . __('entities/relations.hints.mirrored.title') . '"></i>' : null;
            }
        ],
        [
            'field' => 'is_pinned',
            'label' => '<i class="fa-solid-thumbtack" title="' . __('entities/relations.fields.is_star') . '" aria-hidden="true"></i><span class="sr-only">' . __('entities/relations.fields.is_star') . '</span>',
            'render' => function (\App\Models\Relation $model) {
                return $model->isPinned() ? '<i class="fa-solid-thumbtack" aria-hidden="true"></i><span class="sr-only">' . __('entities/relations.fields.is_star') . '</span>' : null;
            }
        ],
        [
            'field' => 'attitude',
        ...
        [
            'field' => 'visibility_id',
            'label' => '<i class="fa-solid-eye" title="' . __('crud.fields.visibility') . '" aria-hidden="true"></i><span class="sr-only">' . __('crud.fields.visibility') . '</span>',
            'render' => function (\App\Models\Relation $model) {

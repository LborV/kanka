        ...
        <div class="flex flex-wrap md:flex-nowrap items-center gap-2 md:gap-2 member-row">
            ...
            @if ($isAdmin)
                <div class="text-lg">
                    ...
                    <i class="fa-solid-unlock-keyhole cursor-pointer hover:text-accent " data-toggle="private" data-private="{{ __('entities/attributes.visibility.private') }}" data-public="{{ __('entities/attributes.visibility.public') }}"></i>
                </div>
            @endif
            <div class="text-lg">

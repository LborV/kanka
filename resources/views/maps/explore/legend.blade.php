        ...
        <li>
            @if(isset($marker['markers']))
                <a href="#" class="map-legend-group" data-animate="collapse" data-target=".map-legend-group-{{ $marker['id'] }}">
                    <span class="map-legend-group-{{ $marker['id'] }}"><x-icon class="fa-solid-folder-open" /></span>
                    <span class="hidden map-legend-group-{{ $marker['id'] }}"><x-icon class="fa-solid-folder" /></span>
                    {!! $marker['name'] !!}
                </a>

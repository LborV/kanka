<div class="join flex items-center">
    ...
    <div class="dropdown entity-actions-dropdown flex items-center join-item">
        ...
        <div class="dropdown-menu hidden" role="menu" id="abilities-submenu">
            ...
            <x-dropdowns.item :link="route('entities.entity_abilities.reset', [$campaign, $entity])" icon="fa-solid-redo">
            ...
            <x-dropdowns.item :link="route('entities.entity_abilities.reorder', [$campaign, $entity])"
                              icon="fa-solid-arrow-up-arrow-down">
                <span class="grow">{{ __('entities/abilities.show.reorder') }}</span>
            </x-dropdowns.item>

            <x-dropdowns.divider />

            <x-dropdowns.item :link="'https://docs.kanka.io/en/latest/entities/abilities.html#entity-abilities'" icon="fa-solid-book">

<x-form :action="['save-filters', $campaign, $entityType, 'm' => $mode]" method="GET" id="crud-filters-form"
    ...
    <x-dialog.article>
        ...
        <x-grid type="1/1">
            ...
            'example' => '<i class=\'fa-solid fa-user-beard-bolt\' aria-hidden=\'true\'></i> <code>fa-solid fa-horse</code>',
            ])">
                ...
                <x-forms.field
                    ...
                    <x-slot name="helper">
                        {!! __('filters.helpers.icon-premium', [
                            'fontawesome' => '<a href="' . config('fontawesome.search') . '" class="text-link">FontAwesome</a>',
                            'example' => '<i class=\'fa-solid-user-beard-bolt\' aria-hidden=\'true\'></i> <code>fa-solid fa-horse</code>',

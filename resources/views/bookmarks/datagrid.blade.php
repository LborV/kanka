...
{!! $datagrid
    ->columns([
        ...
        [
            ...
            'render' => function ($model) {
                if ($model->isDashboard()) {
                    ...
                    return '<i class="fa-solid-star"></i> ' . __('entities.entity');
                } elseif ($model->isList()) {
                    return '<i class="fa-solid-th-list"></i> ' . __('crud.fields.entity_type');
                } elseif ($model->isRandom()) {
                    return '<i class="fa-solid-question"></i> ' . __('dashboards/widgets/random.name');
                }
                return '';
            },
            'disableSort' => true,
        ...
        [
            ...
            'render' => function ($model) {
                if ($model->is_active) {
                    return '<i class="fa-solid-check-circle" aria-hidden="true"></i>';
                }
                return '';
            },
            'field' => 'is_active',

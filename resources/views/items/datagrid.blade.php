...
{!! $datagrid
    ->columns([
        ...
        [
            'label' => '<i class="fa-solid-ruler-combined" aria-hidden="true" title="' . __('items.fields.size') . '"></i> <span class="sr-only">' . __('items.fields.size') . '</span>',
            'field' => 'size',
            'render' => function($model) {
                return $model->size;
            }
        ...
        [
            'label' => '<i class="fa-solid-weight-hanging" aria-hidden="true" title="' . __('items.fields.weight') . '"></i> <span class="sr-only">' . __('items.fields.weight') . '</span>',
            'field' => 'weight',
            'render' => function($model) {
                return $model->weight;
            }

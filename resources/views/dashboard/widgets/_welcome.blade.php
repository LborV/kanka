...
'locations' => '<a href="' . route('locations.index', [$campaign]) . '" class="text-link">' . __('entities.locations') . '</a>',
    ...
    <p>
        {!! __('dashboards/widgets/welcome.intros.2', [
            ...
            'entities' => '<a target="_blank" href="https://docs.kanka.io/en/latest/entities/overview.html" class="text-link">' . __('abilities.show.tabs.entities') . ' <i class="fa-solid fa-external-link" aria-hidden="true"></i></a>',
        ]) !!}
    </p>
    <p class="font-bold">
    ...
    'code' => '<code>@</code>',
    'mention' => '<a target="_blank" href="https://docs.kanka.io/en/latest/features/mentions.html" class="text-link">' . __('dashboards/widgets/welcome.tricks.mention') . ' <i class="fa-solid-external-link" aria-hidden="true"></i></a>',
]) !!}
        </li>
        <li class="">
...
'edit' => '<span class="badge border select-none flex items-center gap-2"><i class="fa-solid fa-pencil" aria-hidden="true"></i> ' . __('campaigns.show.actions.edit') . '</span>',
    ...
    'posts' => '<a target="_blank" href="https://docs.kanka.io/en/latest/features/posts.html" class="text-link">' . __('entities.posts') . ' <i class="fa-solid-external-link" aria-hidden="true"></i></a>']) !!}
        </li>
        <li class="">

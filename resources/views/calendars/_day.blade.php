            ...
            <div class="flex gap-1 items-center mb-0.5">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu hidden" role="menu">
                        <x-dropdowns.item :link="route('calendars.day', [$campaign, $model, 'date' => $day['date']])" icon="fa-solid-clock">
                        ...
                        <x-dropdowns.item link="#" :data="$data" icon="fa-solid-snowflake">
                        ...
                        <div class="flex gap-1 items-center">
                            ...
                            @if ($event->isBirth())
                                @if ($event->year === $day['year'])
                                    <x-icon class="fa-solid-baby" title="{{ __('entities/events.types.birth') }}" tooltip />
                                @else
                                    <x-icon class="fa-solid-birthday-cake" title="{{ __('entities/events.types.birthday') }}" tooltip />
                                @endif
                            @endif
                            @if ($event->isDeath())
                                <x-icon class="fa-solid-skull" title="{{ __('entities/events.types.death') }}" tooltip />
                            @endif
                            @if ($event->is_recurring)
                                <x-icon class="fa-solid-arrows-rotate" tooltip :title="__('calendars.fields.is_recurring')" />
                            @endif
                        </div>

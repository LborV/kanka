                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-4">
                        <div :class="typeClass('worldbuilding')" @click="select('worldbuilding')" tabindex="0" @keydown="handleKeydown($event, 'worldbuilding')">
                            <i class="fa-solid-check-square text-xl" aria-label="Selected" v-if="selected === 'worldbuilding'"></i>
                            <i class="fa-solid-globe text-xl" aria-hidden="true" v-else></i>
                            <div class="flex flex-col gap-1">
                        ...
                        <div :class="typeClass('campaign')" @click="select('campaign')" tabindex="0" @keydown="handleKeydown($event, 'campaign')">
                            <i class="fa-solid-check-square text-xl" aria-label="Selected" v-if="selected === 'campaign'"></i>
                            <i class="fa-solid-dice-d20 text-xl" aria-hidden="true" v-else></i>
                            <div class="flex flex-col gap-1">
                        ...
                        <div :class="typeClass('story')" @click="select('story')" tabindex="0" @keydown="handleKeydown($event, 'story')">
                            <i class="fa-solid-check-square text-xl" aria-label="Selected" v-if="selected === 'story'"></i>
                            <i class="fa-solid-pen-fancy text-xl" aria-hidden="true" v-else></i>
                            <div class="flex flex-col gap-1">

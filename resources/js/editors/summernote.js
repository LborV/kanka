...
const initField = (field) => {
    $(field).summernote({
        ...
        summernoteGallery: {
            buttonLabel: '<i class="fa-solid fa-folder-image"></i>',
...
function hintPostTemplate(item) {
    ...
    return '<div class="post flex items-center gap-1"><i class="fa-solid-chevron-right" aria-hidden="true"></i>' + item.fullname + '</div>';
}

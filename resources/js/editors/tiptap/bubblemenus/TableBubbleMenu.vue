...
<template>
    <div class="flex gap-1 items-center text-xs text-neutral-content px-2">
        ...
        >
            ...
            <i class="fa-solid-plus text-[8px]" aria-hidden="true" />
        </button>
        <button
            ...
            title="Add row"
        >
            <i class="fa-solid-table-rows" aria-hidden="true" />
            <i class="fa-solid-plus text-[8px]" aria-hidden="true" />
        </button>
        <button
            ...
            title="Delete column"
        >
            <i class="fa-solid-table-columns" aria-hidden="true" />
            <i class="fa-solid-minus text-[8px]" aria-hidden="true" />
        </button>
        <button
        ...
        >
            <i class="fa-solid-heading" aria-hidden="true" />
        </button>
        ...
        >
            <i class="fa-solid-border-all" aria-hidden="true" />
        </button>
        <button
        ...
        >
            <i class="fa-solid-bars" aria-hidden="true" />
        </button>
        <button
            ...
            title="Align left"
        >
            <i class="fa-solid-align-left" aria-hidden="true" />
        </button>
        <button
            ...
            title="Align right"
        >
            <i class="fa-solid-align-right" aria-hidden="true" />
        </button>
        ...
        <button
            ...
            title="Delete table"
        >
            <i class="fa-solid-trash" aria-hidden="true" />
        </button>
    </div>
</template>

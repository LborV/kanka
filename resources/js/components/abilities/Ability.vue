            ...
            <div class="flex flex-col gap-4 w-full">
                <div class="flex gap-2 md:gap-4 items-center w-full">
                    <div class="flex gap-2 items-center text-lg grow">
                        ...
                        <i class="fa-solid-user-lock" v-if="ability.visibility_id === 3" v-bind:title="ability.visibility"></i>
                        <i class="fa-solid-users" v-if="ability.visibility_id === 5" v-bind:title="ability.visibility"></i>
                        <i class="fa-solid-user-secret" v-if="ability.visibility_id === 4" v-bind:title="ability.visibility"></i>
                        <i class="fa-solid-eye" v-if="ability.visibility_id === 1" v-bind:title="ability.visibility"></i>
                    </div>

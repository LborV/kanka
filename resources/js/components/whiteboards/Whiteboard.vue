    ...
    <div class="toolbar fixed w-full bg-base-100 p-2 flex items-center justify-between gap-2 z-50" v-if="!loading && !error">
        <div class="flex gap-1 items-center">
            <a :href="urls.overview" :title="trans('back')" class="flex items-center gap-1">
                <i class="fa-solid-left-to-bracket" aria-hidden="true"></i>
            ...
            <div v-if="props.creator" class="relative">
                <button @click="settingsOpen = !settingsOpen"
                    ...
                    <i class="fa-solid-gear" aria-hidden="true"></i>
                </button>
            ...
            <a v-if="props.creator" href="#" @click="openQQ()"  class="quick-creator-button btn2 btn-primary btn-sm"
               tabindex="0">
                <i class="flex-none fa-solid-plus" aria-hidden="true"></i>
    ...
    >
        <div v-if="toolbarMode === 'drawing'" class="flex items-center gap-2 main-toolbar">
            <div class="join">
                ...
                >
                    <i class="fa-solid-paintbrush-fine" aria-hidden="true"></i>
                ...
                >
                    <i class="fa-solid-paintbrush" aria-hidden="true"></i>
                ...
                >
                    <i class="fa-solid-palette" aria-hidden="true"></i>
                ...
                <button
                    ...
                    <i class="fa-solid-check" aria-hidden="true" />
        ...
        <div class="flex items-center gap-2 shape-toolbar " v-else-if="selectedShape">
            <div class="join">
                ...
                >
                    <i class="fa-solid-copy" aria-hidden="true"></i>
                ...
                >
                    <i class="fa-solid-rotate" aria-hidden="true"></i>
            ...
            <div class="join" v-if="selectedShape.type === 'text'">
                <button
                    ...
                    @click.stop="autoFont()"
                >
                    <i class="fa-solid-text-size" aria-hidden="true"></i>
                ...
                >
                    <i class="fa-solid-minus" aria-hidden="true"></i>
            ...
            <div class="join">
                ...
                >
                    <i class="fa-solid-up-to-line" aria-hidden="true"></i>
                ...
                >
                    <i class="fa-solid-down-to-line" aria-hidden="true"></i>
        ...
        <div v-else-if="toolbarMode !== 'drawing' && !readonly" class="flex items-center gap-2 main-toolbar">
            <div class="join">
                <button
                    ...
                    <i class="fa-solid-mouse-pointer" aria-hidden="true"></i>
                ...
                <button
                    ...
                    <i class="fa-solid-square" aria-hidden="true" />
                ...
                <button
                    ...
                    <i class="fa-solid-circle" aria-hidden="true" />
                ...
                <button
                    ...
                    <i class="fa-solid-text" aria-hidden="true" />
                ...
                <button
                    ...
                    class="btn2 btn-sm join-item">
                    <i class="fa-solid-scribble" aria-hidden="true" />
            ...
            <div class="join">
                <button
                    ...
                    <i class="fa-solid-search" aria-hidden="true" />
                ...
                <button
                    ...
                    class="btn2 btn-sm join-item"
                    :class="{ 'btn-disabled': toolbarMode === 'drawing' }">
                    <i class="fa-solid-file-image" aria-hidden="true" />
